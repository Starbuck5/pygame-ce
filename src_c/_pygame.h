...
#define PG_FORMAT_R_LOSS(format) format->Rbits
#define PG_FORMAT_G_LOSS(format) format->Gbits
#define PG_FORMAT_B_LOSS(format) format->Bbits
#define PG_FORMAT_A_LOSS(format) format->Abits
