...
# TODO: check https://github.com/libsdl-org/SDL_mixer/commits/main/include/SDL3_mixer/SDL_mixer.h
# for API changes since initial Python mapping.
...
class Audio:
    ...
    @classmethod
    def from_sine_wave(
        hz: int, amplitude: float, preferred_mixer: Mixer | None = None, ms: int = -1
    ) -> Audio: ...
    @property
    ...
    def get_metadata() -> AudioMetadata: ...
...
class AudioMetadata:
    ...
    album: str | None
    copyright: str | None
    # Maybe track_num would be better to not be "track" as in "Track"
    track: int | None
