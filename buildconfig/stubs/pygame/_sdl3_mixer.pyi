...
T = TypeVar("T")
track_stopped_callback = Callable[[Track, T], None]
# track_mix_callback = Callable[[Track, audio.AudioSpec, Buffer, T], None]
# group_mix_callback = Callable[[Group, audio.AudioSpec, Buffer, T], None]
# post_mix_callback = Callable[[Mixer, audio.AudioSpec, Buffer, T], None]
...
class Track:
    ...
    def set_stopped_callback(
        self, callback: track_stopped_callback | None, userdata: T = None
    ) -> None: ...
    # def set_raw_callback(
    #     self, callback: track_mix_callback | None, userdata: T = None
    # ) -> None: ...
